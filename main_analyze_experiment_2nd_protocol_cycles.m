...
load('../data/18days_4.11/4 exp/data_excluding5msec.mat')

% partial analyze (contamination)
unalize_until = 700;
responses_smoothed_ = responses_smoothed;
responses_smoothed = responses_smoothed(:,1:unalize_until,:,:);
